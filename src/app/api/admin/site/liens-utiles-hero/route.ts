...
import {
  ...
  normalizeLiensUtilesHeroImageUrls,
...
export async function GET() {
  ...
  return NextResponse.json(parseLiensUtilesHeroImageUrlsFromSetting(row?.value));
}
...
export async function PUT(req: NextRequest) {
  ...
  const normalized: LiensUtilesHeroImageUrls = body
    ? normalizeLiensUtilesHeroImageUrls(body)
    : EMPTY_LIENS_UTILES_HERO_IMAGE_URLS;
