...
export async function GET() {
  ...
  return NextResponse.json(parseContactHeroImageUrlsFromSetting(row?.value));
}
...
export async function PUT(req: NextRequest) {
  ...
  const normalized: ContactHeroImageUrls = body
    ? normalizeContactHeroImageUrls(body)
    : EMPTY_CONTACT_HERO_IMAGE_URLS;
